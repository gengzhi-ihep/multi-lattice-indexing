...
*
      DOUBLE PRECISION DUMMY,B,C,ZBQLIX(43),X,B2,BINV
...
*
      ...
      IF (STATUS.LE.0) THEN
       ...
       R = DSQRT( -2.0D0*LOG(ZBQLU01(0.0D0)) )
       ZBQLNOR = (R*COS(THETA))
       SPARE = (R*SIN(THETA))
       STATUS = 1
      ELSE
...
*
 ...
 30    Y = DTAN(PI*ZBQLU01(0.0D0))
       ...
       ELSE
        ...
        IF (LOG(ZBQLU01(0.0D0)).GT.T) GOTO 30
       ENDIF
      ENDIF 
...
*
      DOUBLE PRECISION NU1,NU2,ZBQLGAM,ZBQLBET1,X1,X2
